...
|---|---|---|
| 1 | [Install Python](./01_Install_Python.md) | Installing Python, terminals, IDEs, running scripts, the interactive shell & REPL |
| 2 | [Python Basics](./02_Python_Basics.md) | Variables, comments, data types, strings, numbers, functions, scope, conditionals, booleans |

### Core Building Blocks
| # | Guide | What it covers |
|---|---|---|
| 3 | [Loops & Sequences](./03_Loops_and_Sequences.md) | Lists, tuples, `for`/`while` loops, `range()`, `enumerate()`, `zip()`, list comprehensions, `filter`/`map`, lambdas |
| 4 | [Dictionaries & Sets](./04_Dictionaries_and_Sets.md) | Dictionaries, sets, looping patterns, set math, the Standard Library, import statements |
| 5 | [Error Handling](./05_Error_Handling.md) | Common error types, debugging techniques (`print`, `pdb`, IDE tools), `try`/`except`/`else`/`finally`, custom exceptions |

### Object-Oriented Programming
| # | Guide | What it covers |
|---|---|---|
| 6 | [Classes & Objects](./06_Classes_and_Objects.md) | Class definitions, instance vs class attributes, methods, dunder (magic) methods |
| 7 | [Object-Oriented Programming](./07_Object_Oriented_Programming.md) | Encapsulation, getters/setters/properties, inheritance, polymorphism, name mangling, abstraction |
